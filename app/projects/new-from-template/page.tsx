    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted">
          Start your project faster with a pre-configured template
        </p>
      </div>
            ...
            <div className="mt-4 bg-white rounded-lg shadow p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">
                    {selectedTemplate.defaultTasks.length}
                  </span>
                </div>
                {selectedTemplate.defaultDeliverables && (
                  <div>
                    ...
                    <span className="ml-2 font-medium">
                      {selectedTemplate.defaultDeliverables.length}
                    </span>
                  </div>
                )}
              </div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded-full ${
                        template.branch === "CORTEX"
                          ? "bg-purple-100 text-purple-800"
                          : template.branch === "SOLUTIONS"
